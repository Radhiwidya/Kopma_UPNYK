...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-success w-100 fixed-top">
    <div class="container">
      ...
      <a href="../PHP/Logout.php" class="log" >Keluar</a>
    </div>
  </nav>
  <!--Batas Navbar-->
  <!--Login-->
  <div class="login-box">
    <form action="" method="POST">
      <h2 style="font-size: medium;">Tambah User</h2>
      <div class="input-box">
      ...
      <br>
      <a href="">
        <button name="login" class="btn btn-outline-light" id="submit" type="submit">Daftar</button>
      </a>
    </form>
  </div>
