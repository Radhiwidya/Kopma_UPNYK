...
<body>
  ...
  <div class="content">
    ...
    <br>
    <p>Bidang Riset merupakan bidang yang berfokus pada penelitian, pengengembangan dan perencanaan guna mendukung tugas fungsional dari bidang lainnya. Hal ini bertujuan untuk meningkatkan efisiensi dan optimalisasi pelaksanaan atau eksekusi program kerja fungsional pada bidang lainnya. Selain itu juga, bidang Riset juga mendukung percepatan modernisasi Koperasi menjadi digital, sehingga dapat terus bersaing di tengah disrupsi yang terus terjadi. Dalam bidang Riset terdapat 3 sub bidang, yaitu administrasi, teknologi serta Penelitian dan Perencanaan. Bidang Riset memiliki fungsi untuk melakukan penelitian pasar, penyusunan perencanaan bisnis, mengembangkan web kopma sebagai data base, menganalisis aktivitas keuangan dan menyusun rencana strategis organisasi.</p>
  </div>
  <div class="clear"></div>
  <!-- Batas Konten -->
