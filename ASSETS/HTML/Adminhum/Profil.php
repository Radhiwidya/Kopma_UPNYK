...
<body>
  ...
  <div class="content">
    ...
    <br>
    <p>Bidang Administrasi dan Hubungan Masyarakat (ADMINHUM)
      merupakan salah satu bidang di Koperasi Mahasiswa UPN “Veteran”
      Yogyakarta yang memiliki tanggung jawab terhadap administrasi, legalitas,
      pengelolaan sekretariat, dan penghubung antara KOPMA UPNYK dengan
      pihak lain baik internal maupun eksternal UPN “Veteran” Yogyakarta. Bidang
      ADMINHUM terdiri dari tiga subbidang, yaitu administrasi, hubungan
      masyarakat (Humas), media informasi (Medinfo), dan kerumahtanggaan. </p>
  </div>
  <div class="clear"></div>
  <!-- Batas Konten -->
