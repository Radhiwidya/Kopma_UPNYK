...
<head>
  ...
  <title>Adminhum | KOPMA UPNVY</title>
</head>
...
<body>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="Arsip-Data.php">Arsip Data</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a id="list" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color: white;">
  ...
  <!-- Konten -->
  <div class="content">
    <h3 id="judul">Arsip Data</h3>
    <br>
    <p>Ini adalah konten arsip data!<br> Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! Ini adalah konten arsip data! </p>
  </div>
  <div class="clear"></div>
  <!-- Batas Konten -->
