...
<body>
  ...
  <div class="content">
    ...
    <br>
    <p>Berdasarkan Anggaran Dasar KOPMA UPNYK Bab IV Bagian Ketiga
      Pasal 49 disebutkan bahwa, tugas pengawas yaitu:
      <br>
      a. Memberi nasihat dan pengawasan kepada pengurus<br>
      b. Melakukan pengawasan terhadap kebijakan dan pengelolaan koperasi
      yang dilakukan oleh pengurus dan<br>
      c. Melaporkan hasil pengawasan kepada rapat anggota.<br>
      Oleh karena itu, laporan ini dibuat sebagai bentuk pertanggungjawaban dewan
      pengawas kepada anggota dalam menjalankan satu periode di KOPMA
      UPNYK.</p>
  </div>
  <div class="clear"></div>
  <!-- Batas Konten -->
